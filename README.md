...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fe9d57a934bf90015be4be2
...
To start editing your site, you can use the Sanity interface at https://ggcapital-9d57a.sanity.studio/.
...
Generated at `2020-12-28T12:55:35.531Z` by Stackbit version `0.3.41`.